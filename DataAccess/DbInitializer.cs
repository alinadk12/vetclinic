...
namespace DataAccess
{
    public class DbInitializer : DropCreateDatabaseAlways<DataContext>
    {
        ...
        {         
            ...
            Service ser6 = new Service { Name = "Простой осмотр", TypeOfService = ts1, Price = 150 };
            context.Services.Add(ser6);
            Service ser7 = new Service { Name = "Углубленный осмотр", TypeOfService = ts1, Price = 220 };
            context.Services.Add(ser7);
            Service ser8 = new Service { Name = "Стандартная блокада пятки", TypeOfService = ts3, Price = 350 };
            context.Services.Add(ser8);
            Service ser9 = new Service { Name = "Купирование ушей", TypeOfService = ts4, Price = 650 };
            context.Services.Add(ser9);
